    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="px-6 py-5">
          ...
          {analysis.user_budget !== null && analysis.user_budget !== undefined ? (
            <div
              className={`rounded-xl px-5 py-4 ${
                within_budget ? "bg-emerald-50" : "bg-red-50"
              }`}
            >
              <p
                className={`text-xs font-medium uppercase tracking-wide ${
                  within_budget ? "text-emerald-700" : "text-red-700"
                }`}
              >
              ...
              <p
                className={`mt-1 font-display text-2xl font-semibold ${
                  within_budget ? "text-emerald-800" : "text-red-800"
                }`}
              >
        ...
        {analysis.suggestions.length > 0 ? (
          <div className="mt-5 rounded-xl border border-emerald-100 bg-gradient-to-br from-emerald-50/70 to-teal-50/50 px-5 py-4">
